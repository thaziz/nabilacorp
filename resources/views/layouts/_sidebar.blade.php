                ...
                <ul id="side-menu" class="nav">
                    ...
                    <li  class="menu-primer {{Request::is('inventory') ? 'active' : '' || Request::is('inventory/*') ? 'active' : '' }}"><a href="#"><i class="fa fa-desktop fa-fw">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li class="menu-sekunder {{ Request::is('inventory/p_returncustomer/cust') ? 'active' : '' || Request::is('inventory/p_returncustomer/*') ? 'active' : '' }}"><a href="{{ url('/inventory/p_returncustomer/cust') }}"><span class="submenu-title">Stock Gudang</span><span class="hidden">Inventory</span></a>
                            </li>
