<div id="alert-tab" class="tab-pane fade in active">
    <div class="row">
        <form id="opname">
            ...
            <div class="col-md-10 col-sm-12 col-xs-12">
                <div class="form-group" align="pull-left">
                    <select class="form-control input-sm" id="pemilik" name="o_comp" style="width: 100%;" onclick="clearTable()">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: 20px;margin-bottom: 5px;">
            <button class="btn btn-success kirim-opname" onclick="simpanOpname()" style="float: right" type="button">Kirim</button>
        </div>
