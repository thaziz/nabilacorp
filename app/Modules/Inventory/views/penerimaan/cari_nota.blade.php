            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    <div class="page-header pull-left" style="font-family: 'Raleway', sans-serif;">
                        <div class="page-title">Cari Nomor sNota</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right" style="font-family: 'Raleway', sans-serif;">
                        <li><i class="fa fa-home"></i>&nbsp;<a href="{{ url('/home') }}">Home</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                        <li><i></i>&nbsp;Inventory&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                        <li class="active">Penerimaan Barang Hasil Produksi</li><li><i class="fa fa-angle-right"></i>&nbsp;Cari Nomor Nota&nbsp;&nbsp;</i>&nbsp;&nbsp;</li>
                    </ol>
                    <div class="clearfix">
                    </div>
                </div>
                            ...
                            <div class="row">
                              <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6" align="right">
                                  <a href="{{ url('/inventory/p_hasilproduksi/produksi') }}" class="btn btn-box-tool"><i class="fa fa-arrow-left"></i></a>
                                </div>
                              </div>
