...
<div id="page-wrapper">
    ...
    <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
        <div class="page-header pull-left" style="font-family: 'Raleway', sans-serif;">
            <div class="page-title">POS Belanja Marketing</div>
        </div>
        <ol class="breadcrumb page-breadcrumb pull-right" style="font-family: 'Raleway', sans-serif;">
            <li><i class="fa fa-home"></i>&nbsp;<a href="{{ url('/home') }}">Home</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
            <li><i></i>&nbsp;Penjualan&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
            <li><i></i>&nbsp;<a href="{{url('penjualan/POSpenjualan/POSpenjualan')}}">POS Belanja Marketing</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
            <li class="active">POS Belanja Marketing</li>
        </ol>
        <div class="clearfix">
        </div>
    </div>
            ...
            <div class="row mbl">
                <div class="col-lg-12">
                  ...
                  <ul id="generalTab" class="nav nav-tabs">
                    <li class="active"><a id="penjualan" href="#toko" data-toggle="tab">Belanja Marketing</a></li>
                                <li><a id="list" href="#listtoko" data-toggle="tab">List Belanja Marketing</a></li><!-- 
...
@include('Nabila::belanjamarketing/includes/modal_alter_status')
@include('Nabila::belanjamarketing/js/functions')
@include('Nabila::belanjamarketing/js/format_currency')
...
function table(){
  ...
  tablex = $("#tableListToko").DataTable({        
       ...
       serverSide: true,
       ajax: {
          "url": "{{ url("nabila/belanjamarketing/listPenjualan/data") }}",
          "type": "get",
          data: {
            "_token": "{{ csrf_token() }}",
            "type"  :"marketing",
...
if($status==true){ 
  ...
  $.ajax({
      url     :  baseUrl+'/nabila/belanjamarketing/create',
      type    : 'GET', 
      ...
      success : function(response){    
        ...
        $.ajax({
            url : baseUrl+'/nabila/belanjamarketing/printNota/'+response.s_id,
            type: 'get',
            data    :  formPos+'&status='+status,
            success:function (response){
        ...
        /*window.open(baseUrl+'/nabila/belanjamarketing/printNota/'+response.s_id,'_blank');*/               
    }
...
function perbaruiData(){
  ...
  var formPos=$('#dataPos').serialize();
  $.ajax({
      url     :  baseUrl+'/nabila/belanjamarketing/update',
      type    : 'GET', 
...
function serahFinal(){
   ...
   var formPos=$('#dataPos').serialize();
   $.ajax({
      url     :  baseUrl+'/nabila/belanjamarketing/serah-final',
      type    : 'GET', 
      ...
      success : function(response){    
        ...
        if(response.status=='sukses'){
          ...
          if(response.s_status=='lunas'){
             var childwindow= window.open(baseUrl+'/nabila/belanjamarketing/printNota/'+response.s_id,'_blank');            resetFrom();        
         }
...
function detail(s_id){  
  ...
  dataIndex=1;
  $.ajax({
      url     :  baseUrl+'/nabila/belanjamarketing/'+s_id+'/edit',
      type    : 'GET',  
      data: {
        "_token": "{{ csrf_token() }}",
        "s_status" :statusPos,
...
function listPenjualan(){
    $.ajax({
      url     :  baseUrl+'/nabila/belanjamarketing/listPenjualan',
      type    : 'POST',                     
      data: {
        "_token": "{{ csrf_token() }}"
    },
...
$.ajax({
  url     :  baseUrl+'/nabila/belanjamarketing/detail-view/'+s_id,
  type    : 'GET',                     
  success : function(response){  
    $('.dataDetail').html(''); 
