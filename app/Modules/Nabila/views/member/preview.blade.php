                     ...
                     <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 tamma-bg" style="margin-top:15px;" id="header_form">
                           <form id="form_m_customer" class="form-horizontal" method="post" style="padding: 3mm;margin-left:2mm;margin-right: 2mm">
                              {{ csrf_field() }}
                                 <input readonly type="hidden" name="c_id" value="{{ $m_customer->c_id }}">
                                       ...
                                       <div class="form-group">
                                          ...
                                          <div class="col-xs-8 col-lg-8 inputGroupContainer">
                                             <div class="input-group">
                                                ...
                                                <input readonly type="text" class="form-control" id="name" name="c_name" value="{{ $m_customer->c_name }}"   placeholder="Masukkan Nama Member" style="text-transform: uppercase" />
                                             </div>
                                          </div>
                                       </div>
                                       ...
                                       <div class="form-group">
                                          ...
                                          <div class="col-xs-8 col-lg-8 inputGroupContainer">
                                             <div class="input-group">
                                                ...
                                                <input readonly type="text" class="form-control" id="email" name="c_email" value="{{ $m_customer->c_email }}"  placeholder="Masukkan Alamat Email" />
                                             </div>
                                          </div>
                                       </div>
                                    </article>
                                    <article class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                       <div class="form-group">
                                          ...
                                          <div class="col-xs-8 col-lg-8">
                                             <input readonly type="text" name="c_birthday" value="{{ $m_customer->c_birthday_label }}"  id="c_birthday" class="form-control">
                                          </div>
                                       </div>
                                       <div class="form-group">
                                          <label class="col-xs-4 col-lg-4 control-label text-left">Alamat Member</label>
                                          <div class="col-xs-8 col-lg-8 inputGroupContainer">
                                             <textarea disabled class="form-control" rows="5" style="resize: none;" placeholder="Masukkan Alamat Member" id="address" name="c_address">{{ $m_customer->c_address }}</textarea>
                                          </div>
                                       </div>
                                    </article>
                                 </div>
