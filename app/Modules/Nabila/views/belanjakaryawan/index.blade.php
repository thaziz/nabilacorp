...
<div id="page-wrapper">
    ...
    <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
        <div class="page-header pull-left" style="font-family: 'Raleway', sans-serif;">
            <div class="page-title">POS Belanja Karyawan</div>
        </div>
        <ol class="breadcrumb page-breadcrumb pull-right" style="font-family: 'Raleway', sans-serif;">
            <li><i class="fa fa-home"></i>&nbsp;<a href="{{ url('/home') }}">Home</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
            <li><i></i>&nbsp;Penjualan&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
            <li><i></i>&nbsp;<a href="{{url('penjualan/POSpenjualan/POSpenjualan')}}">POS Belanja Karyawan</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
            <li class="active">POS Belanja Karyawan</li>
        </ol>
        <div class="clearfix">
        </div>
    </div>
            ...
            <div class="row mbl">
                <div class="col-lg-12">
                  ...
                  <ul id="generalTab" class="nav nav-tabs">
                    <li class="active"><a id="penjualan" href="#toko" data-toggle="tab">Belanja Karyawan</a></li>
                                <li><a id="list" href="#listtoko" data-toggle="tab">List Belanja Karyawan</a></li><!-- 
...
@include('Nabila::belanjakaryawan/js/functions')
@include('Nabila::belanjakaryawan/js/format_currency')
...
$(document).ready(function(){      
  $("[name='s_nama_cus']").select2({
      ...
      ajax: {
        url: '{{ url("/nabila/belanjakaryawan/find_pegawai") }}',
        dataType: 'json',
...
function table(){
  ...
  tablex = $("#tableListToko").DataTable({        
       ...
       serverSide: true,
       ajax: {
          "url": "{{ url("nabila/belanjakaryawan/listPenjualan/data") }}",
          "type": "get",
          data: {
            "_token": "{{ csrf_token() }}",
            "type"  :"karyawan",
...
if($status==true){ 
  ...
  $.ajax({
      url     :  baseUrl+'/nabila/belanjakaryawan/create',
      type    : 'GET', 
      ...
      success : function(response){    
        ...
        $.ajax({
            url : baseUrl+'/nabila/belanjakaryawan/printNota/'+response.s_id,
            type: 'get',
            data    :  formPos+'&status='+status,
            success:function (response){
        ...
        /*window.open(baseUrl+'/nabila/belanjakaryawan/printNota/'+response.s_id,'_blank');*/               
    }
...
function perbaruiData(){
  ...
  var formPos=$('#dataPos').serialize();
  $.ajax({
      url     :  baseUrl+'/nabila/belanjakaryawan/update',
      type    : 'GET', 
...
function serahFinal(){
   ...
   var formPos=$('#dataPos').serialize();
   $.ajax({
      url     :  baseUrl+'/nabila/belanjakaryawan/serah-final',
      type    : 'GET', 
      ...
      success : function(response){    
        ...
        if(response.status=='sukses'){
          ...
          if(response.s_status=='lunas'){
             var childwindow= window.open(baseUrl+'/nabila/belanjakaryawan/printNota/'+response.s_id,'_blank');            resetFrom();        
         }
...
function detail(s_id){  
  ...
  dataIndex=1;
  $.ajax({
      url     :  baseUrl+'/nabila/belanjakaryawan/'+s_id+'/edit',
      type    : 'GET',  
      data: {
        "_token": "{{ csrf_token() }}",
        "s_status" :statusPos,
...
function listPenjualan(){
    $.ajax({
      url     :  baseUrl+'/nabila/belanjakaryawan/listPenjualan',
      type    : 'POST',                     
      data: {
        "_token": "{{ csrf_token() }}"
    },
...
$.ajax({
  url     :  baseUrl+'/nabila/belanjakaryawan/detail-view/'+s_id,
  type    : 'GET',                     
  success : function(response){  
    $('.dataDetail').html(''); 
