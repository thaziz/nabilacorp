...
class BelanjaResellerController extends Controller
{
    ...
    { 
      ...
      /*$data['toko']=view('Nabila::belanjareseller/pesanan');      
      $data['listtoko']=view('Nabila::belanjareseller/listpesanan');   
      return view('Nabila::belanjareseller/pos-pesanan',compact('data'));
*/
      ...
      $data['toko']=view('Nabila::belanjareseller/pesanan',compact('machine','paymentmethod','daftarHarga'));      
      $data['listtoko']=view('Nabila::belanjareseller/listpesanan');   
      return view('Nabila::belanjareseller/index',compact('data','pm','printPl'));
...
$totalBayar=0;
    ...
    function penjualanDtPesanan($id,Request $request){  
      ...
      return view('Nabila::belanjareseller/editDetailPenjualan',compact('data','tamp','status'));
    ...
    function penjualanViewDtPesanan($id){            
      ...
      $tamp=array_map("strval",$tamp);      
      return view('Nabila::belanjareseller/viewDetailPenjualan',compact('data','tamp'));
      
    }

    function listPenjualanPesanan(Request $request){
      if($request->ajax()){
        return view('Nabila::belanjareseller/tableListPesanan');
      }else{
        return 'f';
      }
          ...
          return Datatables::of($d_sales)
                      ...
                      ->editColumn('s_status', function ($d_sales) {
                            ...
                            if (strtolower($d_sales->s_status) == 'terima')
                                return '<span class="label label-info">Terima</span>';
                        })
  ...
  function printNotaPesanan($id, Request $request){
      ...
      for ($i=0; $i <count($request->sp_nominal) ; $i++) { 
        ...
        $sp_nominal['date'][$i]=date('d-m-Y',strtotime($request->sp_sdate[$i]));
      }         */   
     ...
     return view('Nabila::belanjareseller/printNota',compact('data','kembalian','bayar','jumlah','piutang','ttlBayar'));
     
   
  }

   public function POSpenjualanPesanan() {
      return view('Nabila::belanjareseller/pos-pesanan');
   }
