                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12 tamma-bg" style="padding-bottom: 10px;padding-top: 20px;margin-bottom: 15px;">
                                            ...
                                            <div class="col-md-3 col-sm-8 col-xs-12">
                                                <div class="form-group">
                                                    <input id="m_id" type="hidden" class="form-control input-sm disable"
                                                        name="m_id">
                                            ...
                                            <div class="col-md-3 col-sm-8 col-xs-12">
                                                <div class="form-group">
                                                    <input class="form-control datepicker2 input-sm disable" value="02-02-1990"
                                            ...
                                            <div align="right" style="padding-top:10px;">
                                                <div id="div_button_save" class="form-group">
                                                    <button type="button" id="button_save" class="btn btn-primary"
                                                        onclick="simpanDataUser()">Simpan Data</button>
                                                </div>
                                            </div>
                                            ...
                                            <table class="table tabelan table-bordered table-hover" id="data-detail">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr style="background: #f7e8e8">
                                                        ...
                                                        <td>
                                                            <input type="hidden" value="N" class="checkbox" name="insert[]"
                                                                id="insert-{{$data->a_id}}">
                                                        </td>
                                                        <td>
                                                            <input type="hidden" value="N" class="checkbox" name="update[]"
                                                                id="update-{{$data->a_id}}">
                                                        </td>
                                                        <td>
                                                            <input type="hidden" value="N" class="checkbox" name="delete[]"
                                                                id="delete-{{$data->a_id}}">
                                                        </td>
                                                        <td>
                                                            <input type="hidden" value="N" class="checkbox" name="laporan[]"
                                                                id="laporan-{{$data->a_id}}">
                                                        </td>
                                                        <td>

                                                            <input type="hidden" value="N" class="checkbox" name="unlock[]"
                                                                id="unlock-{{$data->a_id}}">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <input type="checkbox" class="checkbox" name="laporan[]"
                                                                onchange="simpanLaporan('{{$data->a_id}}')" id="laporan-{{$data->a_id}}">
                                                        </td>
                                                        <td class="text-center">
                                                            <input type="checkbox" class="checkbox" name="unlock[]"
                                                                onchange="simpanUnlock('{{$data->a_id}}')" value="1" id="unlock-{{$data->a_id}}">
                                                        </td>
                                                    </tr>
                                                    @endif
