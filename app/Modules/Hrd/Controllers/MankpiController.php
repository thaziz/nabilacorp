...
class MankpiController extends Controller
{
    ...
    {
        $tabIndex = view('Hrd::manajemenkpi.tab-index');
        $tabLaporan = view('Hrd::manajemenkpi.tab-laporan');
        $tabModal = view('Hrd::manajemenkpi.modal');
        $modalDetail = view('Hrd::manajemenkpi.modal-detail');
        $modalEdit = view('Hrd::manajemenkpi.modal-edit');
        return view('Hrd::manajemenkpi/index',compact('tabIndex','tabLaporan','tabModal','modalDetail','modalEdit'));
    }
