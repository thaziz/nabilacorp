  ...
  function detailLembur(id, $jenis) {
    $.ajax({
      ...
      success: function (data) {
        ...
        if (jenpeg != "MAN") {
          var newJenPeg = "Manajemen";
        } else {
          var newJenPeg = "Produksi";
        }
        ...
        $('#append-detail').html(
          '<a href="' + baseUrl + '/hrd/datalembur/print/' + id + '/' + jenpeg +
          '" class="btn btn-primary" target="_blank"><i class="fa fa-print"></i>&nbsp;Print</a>' +
