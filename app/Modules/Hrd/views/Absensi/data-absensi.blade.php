<div class="panel-body">
    <a href="javascript:void(0);" onclick="javascipt:window.open('{{url('/public/assets/berkas/absensi-produksi/contoh-master-produksi.xlsx')}}');"><button
    ...
    <form style="border: 4px solid #a1a1a1;margin-top: 15px;padding: 10px;     margin-bottom: 16px;" action="{{url('/import/data-produksi')}}"
...
<div class="col-md-2 col-sm-3 col-xs-12" align="center">
    <button class="btn btn-primary btn-sm btn-flat autoCari" type="button" onclick="detTanggal()">
        <strong>
            <i class="fa fa-search" aria-hidden="true"></i>
        </strong>
    </button>
    <button class="btn btn-info btn-sm btn-flat refresh-data2" type="button" onclick="detTanggal()">
        <strong>
