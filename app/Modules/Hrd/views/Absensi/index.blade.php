                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div style="margin-left:-5px;">
                    ...
                    <div class="panel-body">
                      <a href="javascript:void(0);" onclick="javascipt:window.open('{{url('/public/assets/berkas/absensi-manajemen/contoh-master-manajemen.xlsx')}}');"><button
                          class="btn btn-success">Download Contoh Master</button></a>
                      <a href="{{ url('/export/id-manajemen') }}"><button class="btn btn-success">Download ID Manajemen</button></a>
                      <form style="border: 4px solid #a1a1a1;margin-top: 15px;padding: 10px;     margin-bottom: 16px;"
                        action="{{url('/import/data-manajemen')}}" class="form-horizontal" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                      ...
                      <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="form-group">
                          <div class="input-daterange input-group">
                            <input id="datepicker01" class="form-control input-sm" name="tanggal">
                            <span class="input-group-addon">-</span>
                            <input id="datepicker02" class="input-sm form-control datepicker2" name="tanggal" type="text"
                              value="{{ date('d-m-Y') }}">
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-md-2 col-sm-3 col-xs-12" align="center">
                      ...
                      <button class="btn btn-info btn-sm btn-flat refresh-data2" type="button" onclick="getTanggal()">
                        <strong>
                    ...
                    <div class="col-md-5 col-sm-3 col-xs-12" align="right">
                      <select name="tampilData" id="tampil_data" onchange="getTanggal()" class="form-control input-sm">
                        @foreach ($divisi as $devisi)
                        <option value="{{$devisi->c_id}}" class="form-control input-sm">{{$devisi->c_divisi}}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                ...
                <div class="col-lg-12">
                  <div class="panel-body">
                    <div class="table-responsive">
                      <form id="Absensi">
                        <table id="tableAbsensi" class="table tabelan table-hover table-bordered" width="100%"
                          cellspacing="0">
                          <thead>
                            <tr>
                              <th>Tanggal</th>
          ...
          function detTanggal() {
            ...
            $('#detailAbsensi').DataTable({
              ...
              "columns": [{
                ...
                {
                  "data": 'app_scan_pulang',
                  name: 'app_scan_pulang',
                  orderable: false,
                  width: "10%"
                },
                {
                ...
                {
                  "data": 'app_jml_jamkerja',
                  name: 'app_jml_jamkerja',
                  orderable: false,
                  width: "10%"
                },
              ],
