      ...
      success: function (response) {
        if (response.status == "sukses") {
          ...
          Object.keys(response.kpi).forEach(function () {
            ...
            if (tgl != null) {
              var newTgl = tgl.split("-").reverse().join("-");
            }
            $('#appending').append(
              '<div class="col-md-12 col-sm-12 col-xs-12">' +
              '<label class="tebal">' + response.kpi[key - 1].kpix_name +
              ' | Bobot : <span style="color:#8080ff;">' + response.kpi[key - 1].kpix_bobot +
              '</span> | Target : <span style="color:#8080ff;">' + response.kpi[key - 1].kpix_target +
              '</span> | Deadline : <span style="color:#8080ff;">' + newTgl + '</span></label>' +
              '</div>' +
              ...
              '<input type="hidden" id="index_kpi" name="index_kpix[]" class="form-control input-sm" value="' +
              response.kpi[key - 1].kpix_id + '">' +
              '</div>' +
              '</div>');
            i = randString(5);
            key++;
  ...
  function detailKpix(id) {
    $.ajax({
      ...
      success: function (response) {
        ...
        if (date != null) {
          var newTglKpix = date.split("-").reverse().join("-");
        }
        ...
        Object.keys(response.data).forEach(function () {
          ...
          $('#d_appending').append(
            '<div class="col-md-12 col-sm-12 col-xs-12">' +
            '<label class="tebal">' + response.data[key - 1].kpix_name +
            ' | Bobot : <span style="color:#8080ff;">' + response.data[key - 1].kpix_bobot +
            '</span> | Target : <span style="color:#8080ff;">' + response.data[key - 1].kpix_target +
            '</span> | Deadline : <span style="color:#8080ff;">' + newTgl + '</span></label>' +
            '</div>' +
            '<div class="col-md-12 col-sm-12 col-xs-12" id="row' + i + '">' +
            '<div class="form-group">' +
            '<input type="text" id="d_value_kpi" name="d_value_kpix[]" class="form-control input-sm" value="' +
            response.data[key - 1].d_kpixdt_value + '" readonly>' +
            '<input type="hidden" id="d_index_kpi" name="d_index_kpix[]" class="form-control input-sm" value="' +
            response.data[key - 1].kpix_id + '" readonly>' +
            '<input type="hidden" id="d_dt" name="d_index_dt[]" class="form-control input-sm" value="' +
            response.data[key - 1].d_kpixdt_id + '" readonly>' +
            '</div>' +
            '</div>');
          i = randString(5);
          key++;
      ...
      success: function (response) {
        ...
        Object.keys(response.data).forEach(function () {
          ...
          $('#e_appending').append(
            ...
            '<div class="col-md-12 col-sm-12 col-xs-12" id="row' + i + '">' +
            '<div class="form-group">' +
            '<input type="text" id="e_value_kpi" name="e_value_kpix[]" class="form-control input-sm" value="' +
            response.data[key - 1].d_kpixdt_value + '">' +
            '<input type="hidden" id="e_index_kpi" name="e_index_kpix[]" class="form-control input-sm" value="' +
            response.data[key - 1].kpix_id + '">' +
            '<input type="hidden" id="e_dt" name="e_index_dt[]" class="form-control input-sm" value="' +
            response.data[key - 1].d_kpixdt_id + '">' +
            '</div>' +
            '</div>');
          i = randString(5);
          key++;
