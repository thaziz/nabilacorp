      ...
      success: function (response) {
        ...
        Object.keys(response.list).forEach(function () {
          $('#appending-modal').append(
            '<input type="hidden" id="index_tunjangan" name="index_tunjangan[]" class="form-control input-sm" value="' +
            response.list[key - 1] + '">' +
            '<input type="hidden" id="nilai_tunjangan" name="nilai_tunjangan[]" class="form-control input-sm" value="' +
            response.nilai_tunjangan[key - 1] + '">');
          i = randString(5);
          key++;
        });
        Object.keys(response.potonganTxt).forEach(function () {
          $('#appending-modal').append(
            '<input type="hidden" id="harian" name="harian[]" class="form-control input-sm" value="' +
            response.potonganTxt[key2 - 1].harian + '">' +
            '<input type="hidden" id="harianmakan" name="harianmakan[]" class="form-control input-sm" value="' +
            response.potonganTxt[key2 - 1].harianmakan + '">' +
            '<input type="hidden" id="harianmakantrans" name="harianmakantrans[]" class="form-control input-sm" value="' +
            response.potonganTxt[key2 - 1].harianmakantrans + '">');
          i = randString(5);
          key2++;
        });
      },
  ...
  function detailPman(id) {
    $.ajax({
      ...
      success: function (response) {
        ...
        if (date != null) {
          var newKpixDate = date.split("-").reverse().join("-");
        }
        ...
        $('#d_appending').append(
          ...
          '</td>' +
          '</tr>');
        $('#btn-modal').html('<a href="' + baseUrl + '/hrd/payrollman/print-payroll/' + id +
