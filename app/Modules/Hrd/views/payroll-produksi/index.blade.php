            ...
            <div class="row mbl">
                <div class="col-lg-12">
                    ...
                    <ul id="generalTab" class="nav nav-tabs">
                        <li class="active"><a href="#alert-tab" data-toggle="tab" onclick="cariData()">Data Pegawai
                                Produksi</a></li>
                        <li><a href="#note-tab" data-toggle="tab" onclick="cariGaji();pilihAbsensi()">Payroll Pegawai
                                Produksi</a></li>
                    </ul>
                        ...
                        <div id="alert-tab" class="tab-pane fade in active">
                            {{-- <div id="note-tab" class="tab-pane"> --}}
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-12 col-xs-12">
                                        <div class="form-group" align="pull-left">
                                            <select class="form-control input-sm" id="itemData" name="d_hg_cid" style="width: 100%;"
                                                onclick="cariData()">
                                    ...
                                    <div class="col-md-4 col-sm-12 col-xs-12">
                                        <div class="form-group" align="pull-left">
                                            <select class="form-control input-sm" id="jabatanData" name="c_jabatan_pro_id"
                                                style="width: 100%;" onclick="cariData()">
                                    ...
                                    <div class="col-md-3 col-sm-12 col-xs-12">
                                        <div class="form-group" align="pull-left">
                                            <div class="input-daterange input-group">
                                                <input id="tanggal01" class="form-control input-sm datepicker1" name="tanggal"
                                                    type="text" value="">
                                                <span class="input-group-addon">-</span>
                                                <input id="tanggal02" class="input-sm form-control datepicker2" name="tanggal"
                                    ...
                                    <div class="col-md-1 col-sm-12 col-xs-12" align="right">
                                        <button class="btn btn-primary btn-sm btn-flat autoCari" type="button" onclick="cariData()">
                                            <strong>
                ...
                <script type="text/javascript">
                    ...
                    function cariData() {
                        ...
                        var tableActual = $('#data-garapan').DataTable({
                            ...
                            "autoWidth": false,
                            "ajax": {
                                url: baseUrl + "/produksi/garapan/table/data/" + Rumah + "/" + Item + "/" +
                                    Jabatan + "/" + tgl1 + "/" + tgl2,
                                type: 'GET'
                            },
                            "columns": [{
                    ...
                    function cariGaji() {
                        ...
                        if (pilih == 'GR') {
                            ...
                            var tableActual = $('#dataGaji').DataTable({
                                ...
                                "autoWidth": false,
                                "ajax": {
                                    url: baseUrl + "/hrd/payroll/table/gaji/GR/" + Rumah + "/" + Jabatan + "/" +
                                        tgl1 + "/" + tgl2,
                                    type: 'GET'
                                },
                                "columns": [{
                            ...
                            var tableActual = $('#dataGaji').DataTable({
                                ...
                                "autoWidth": false,
                                "ajax": {
                                    url: baseUrl + "/hrd/payroll/table/gaji/" + Rumah + "/" + Jabatan + "/" +
                                        tgl1 + "/" + tgl2,
                                    type: 'GET'
                                },
                                "columns": [{
