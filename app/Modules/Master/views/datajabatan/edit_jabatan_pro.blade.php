...
<div id="page-wrapper">
  ...
  <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    ...
    <ol class="breadcrumb page-breadcrumb pull-right" style="font-family: 'Raleway', sans-serif;">
      ...
      <li>
        <i class="fa fa-angle-right"></i>&nbsp;Edit Data Jabatan&nbsp;&nbsp;</i>&nbsp;&nbsp;</li>
    </ol>
    <div class="clearfix">
    </div>
  </div>
              ...
              <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: -10px; margin-bottom: 10px;">
                  <div class="col-md-5 col-sm-6 col-xs-8">
                    <h4>Edit Data Jabatan Produksi</h4>
                  </div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: 15px;">
                  ...
                  <form method="POST" class="form" action="{{ url('master/datajabatan/pro/update-jabatan') }}/{{$jPro->c_id}}" enctype="multipart/form-data"
                    ...
                    <table class="table">
                      ...
                      <div class="col-md-10 col-sm-8 col-xs-12">
                        <div class="form-group">
                          <input required type="text" name="c_posisi" id="c_posisi" class="form-control input-sm" value="{{$jPro->c_jabatan_pro}}">
                        </div>
                      </div>
                    </table>
                    <div class="col-sm-12">
