...
<div id="page-wrapper">
  ...
  <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    ...
    <ol class="breadcrumb page-breadcrumb pull-right" style="font-family: 'Raleway', sans-serif;">
      ...
      <li>
        <i class="fa fa-angle-right"></i>&nbsp;Tambah Data Posisi&nbsp;&nbsp;</i>&nbsp;&nbsp;</li>
    </ol>
    <div class="clearfix">
    </div>
  </div>
                    ...
                    <table class="table">
                      ...
                      <div class="col-md-10 col-sm-8 col-xs-12">
                        <div class="form-group">
                          <input required type="text" name="c_subdivisi" id="c_posisi" class="form-control input-sm" value="">
                        </div>
                      </div>
                    </table>
                    <div class="col-sm-12">
                      <input type="submit" value="Simpan" onclick="tambahPosisi();" class="btn btn-warning pull-right submitPosisi">
                    </div>
                  </form>
                </div>
              </div>
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status == 'sukses') {
                    ...
                    $('.submitPosisi').removeAttr('disabled', 'disabled');
                }
            }
        })
        }
