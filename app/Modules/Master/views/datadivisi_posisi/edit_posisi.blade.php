...
<div id="page-wrapper">
  ...
  <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left" style="font-family: 'Raleway', sans-serif;">
      <div class="page-title">Data Posisi</div>
    </div>
    <ol class="breadcrumb page-breadcrumb pull-right" style="font-family: 'Raleway', sans-serif;">
      ...
      <li>
        <i></i>&nbsp;HRD&nbsp;&nbsp;
        <i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
      <li class="active">Data Posisi</li>
      <li>
        <i class="fa fa-angle-right"></i>&nbsp;Edit Data Posisi&nbsp;&nbsp;</i>&nbsp;&nbsp;</li>
    </ol>
    <div class="clearfix">
    </div>
  </div>
  <div class="page-content">
    <div id="tab-general">
                    ...
                    <table class="table">
                      ...
                      <div class="col-md-10 col-sm-8 col-xs-12">
                        <div class="form-group">
                          <input required type="text" name="c_subdivisi" id="c_posisi" class="form-control input-sm" value="{{ $posisi->c_subdivisi}}">
                        </div>
                      </div>
                    </table>
                    <div class="col-sm-12">
                      <input type="submit" value="Simpan" onclick="updatePosisi({{$posisi->c_id}});" class="btn btn-warning pull-right submitDivisi">
                    </div>
                  </form>
                </div>
              </div>
      ...
      <script type="text/javascript">
        ...
        $.ajax({
            url: baseUrl + "/master/divisi/posisi/update/" + id,
            type: 'POST',
            data: a,
