...
class laporan_neraca_controller extends Controller
{
    									...
    									->with([
											'akun' => function($query) use ($d1){
												$query->select(DB::raw('distinct(ak_kelompok)'), 'ak_group_neraca')
														...
														->groupBy('ak_kelompok', 'ak_group_neraca');
											}
    									])
    									->where('ag_isactive', '1');
    						}
    ...
    public function print(Request $request){
        ...
        return view('modul_keuangan.laporan.neraca.print.index', compact('data'));
    }
    ...
    public function excel(Request $request){
        ...
        $title = "Laporan_Neraca_".$d1.".xlsx";

        // return view('modul_keuangan.laporan.jurnal.print.excel', compact('data'));

        return Excel::download(new exporter('modul_keuangan.laporan.neraca.print.excel', $data), $title);
    }
}
